      ...
      <div className="border-b border-slate-100 dark:border-border pb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Select value={filterPeriod} onValueChange={setFilterPeriod}>
            ...
            <SelectContent>
              <SelectItem value="semua">Semua Periode Tryout</SelectItem>
              <SelectItem value="bulan_ini">Pelaksanaan Bulan Ini</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="p-6 rounded-3xl ring-0 bg-white dark:bg-card border border-slate-100 dark:border-border shadow-xs flex flex-col justify-between gap-0">
          ...
          <Button
            ...
            className="mt-6 w-full py-2.5 h-auto rounded-xl bg-rose-500 hover:bg-rose-600 text-white text-xs font-bold shadow-xs gap-2"
          >
        ...
        <Card className="p-6 rounded-3xl ring-0 bg-white dark:bg-card border border-slate-100 dark:border-border shadow-xs flex flex-col justify-between gap-0">
          ...
          <Button
            ...
            disabled={!summary}
            className="mt-6 w-full py-2.5 h-auto rounded-xl text-white text-xs font-bold shadow-xs gap-2 bg-[#FF6B6B] hover:bg-[#E85D5D] disabled:opacity-50"
          >
        ...
        <Card className="p-6 rounded-3xl ring-0 bg-white dark:bg-card border border-slate-100 dark:border-border shadow-xs flex flex-col justify-between gap-0">
          ...
          <Button
            ...
            className="mt-6 w-full py-2.5 h-auto rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold shadow-xs gap-2"
          >
